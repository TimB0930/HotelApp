<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="Hotel.WebForm2" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 style="margin-left: 320px">Employee Page</h1>
            <br />
            EmpId:&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Password:
            ...
            <br />
            Rule:
            <asp:TextBox ID="RuleTB" runat="server"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Rank:
            <asp:TextBox ID="RankTB" runat="server"></asp:TextBox>
            <br />
            <br />
            First Name:
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Last Name:
            ...
            <br />
            Address:
            <asp:TextBox ID="AddressTB" runat="server" Width="851px"></asp:TextBox>
            <br />
            <br />
            Direct Deposit:
            <asp:TextBox ID="DirectDepositTB" runat="server"></asp:TextBox>
            <br />
            <br />
            Other:
            <asp:TextBox ID="Misc1" runat="server" Height="94px" Width="882px"></asp:TextBox>
            <br />
            <br />
            <br />
            <br />
